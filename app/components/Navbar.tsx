    ...
    <nav className="bg-white/90 backdrop-blur-md border-b px-6 py-3 flex items-center justify-between sticky top-0 z-[100] shadow-sm">
      ...
      <div className="flex items-center gap-10">
        ...
        <div className="hidden lg:flex items-center gap-6 text-[14px] font-bold text-gray-600">
          <Link href="/" className="hover:text-[#ff5722] transition">Trang chủ</Link>
          ...
          <div className="relative group py-2">
            <button className="flex items-center gap-1 hover:text-[#ff5722] transition group-hover:text-[#ff5722]">
          ...
          <Link href="/conversation" className="hover:text-[#ff5722] transition">Hội thoại</Link>
          <Link href="/reading" className="hover:text-[#ff5722] transition">Đọc hiểu</Link>
          <Link href="/radicals" className="hover:text-[#ff5722] transition">Bộ thủ</Link>
          <Link href="/translate" className="hover:text-[#ff5722] transition">Dịch thuật</Link>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        {!isSignedIn ? (
          ...
          <div className="flex items-center gap-3 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-100">
            <span className="text-[12px] font-bold text-gray-500 hidden sm:block">Mừng bạn quay lại!</span>
            <UserButton  />
          </div>
        )}
      </div>
